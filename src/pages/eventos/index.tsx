...
import { ArrowLeft, Calendar, MapPin, Star, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO 
        ...
        ogType="website"
        ogImage="/images/eventos/portada.jpg"
      ...
      <div className="relative">
        ...
        <div className="relative h-[500px] overflow-hidden">
          <img 
            src="/images/eventos/portada.jpg" 
            alt="Eventos Hero"
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 translate-y-1/2 w-full px-4">
          <div className="max-w-3xl mx-auto bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 text-center">
            <h2 className="text-2xl font-bold text-[#2d472f] mb-4">Descubre nuestros próximos eventos</h2>
            <p className="text-gray-700">Mantente al día con las últimas actividades, talleres y lanzamientos de Black Colors</p>
          </div>
        </div>
      </div>
