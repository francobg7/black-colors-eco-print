  ...
  <section className="py-8 md:py-12 relative overflow-hidden bg-white">
    ...
    <div className="relative z-10 container mx-auto px-4 sm:px-6 md:px-8">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8" style={{ color: '#4b6d3b' }}>
            Quiénes Somos
          </h2>
          <div className="space-y-6 text-xl leading-relaxed" style={{ color: '#4b6d3b' }}>
            ...
            <blockquote className="text-3xl font-medium italic border-l-4 pl-8 my-8 transform hover:scale-105 transition-transform duration-300" style={{ color: '#4b6d3b', borderColor: '#2f9e44' }}>
              "Nunca damos un no, resolvemos lo que el cliente necesita"
            </blockquote>
            <p>
              Grandes empresas como <span className="font-semibold text-xl" style={{ color: '#4b6d3b' }}>Garden, Cavallaro, Inpaco</span> y muchas más confían en nuestra trayectoria y compromiso con la excelencia.
            </p>
          </div>
        </div>
