import { CheckCircle, Wrench, Headphones, Zap, TrendingUp, Search, Users } from 'lucide-react';
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10">
            <div className="text-center space-y-6 max-w-5xl mx-auto px-8">
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                <h3 className="text-2xl lg:text-4xl font-bold text-emerald-200 leading-tight tracking-tight animate-fade-in-up animation-delay-300" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8), 4px 4px 8px rgba(0,0,0,0.6)' }}>
                  PARA TU EMPRESA
                </h3>
              </div>
              ...
              <div className="max-w-4xl mx-auto space-y-4 animate-fade-in animation-delay-400">
                ...
                <p className="text-lg lg:text-xl text-gray-200 leading-relaxed font-bold max-w-3xl mx-auto animate-fade-in-up animation-delay-600" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.9), 4px 4px 8px rgba(0,0,0,0.7), 6px 6px 12px rgba(0,0,0,0.5)' }}>
                  Nos encargamos de la consultoría, capacitación y soporte especializado. Sin soluciones genéricas, sin servicios estándar.
                </p>
              </div>
            </div>
          </div>
          ...
          <section className="w-full bg-gradient-to-br from-blue-50/30 to-indigo-100/20 py-24 rounded-3xl">
            <div className="container mx-auto px-8">
              ...
              <div className="text-center mb-20">
                ...
                <h4 className="text-4xl font-bold text-emerald-600 mb-6 tracking-tight">
                  IMPRESORAS Y TINTAS
                </h4>
                <div className="w-24 h-px bg-emerald-400 mx-auto mb-8"></div>
                <p className="text-xl text-gray-600 leading-relaxed font-bold max-w-4xl mx-auto">
              ...
              <div className="text-center">
                <div className="bg-gradient-to-r from-blue-50/50 to-indigo-100/30 rounded-3xl p-12 border border-blue-200/30">
                  <p className="text-xl text-gray-700 leading-relaxed font-bold max-w-4xl mx-auto">
